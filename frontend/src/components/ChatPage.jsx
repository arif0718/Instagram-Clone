...
const ChatPage = () => {
    ...
    const sendMessageHandler = async (receiverId) => {
        try {
            // http://localhost:8000/ => https://instavibe-uzz9.onrender.com/ 
            const res = await axios.post(`https://instavibe-uzz9.onrender.com/api/v1/message/send/${receiverId}`, { textMessage }, {
                headers: {
